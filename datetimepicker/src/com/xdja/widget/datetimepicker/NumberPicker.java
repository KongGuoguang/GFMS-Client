...
public class NumberPicker extends View {
    ...
    private static final int DEFAULT_FLAG_TEXT_COLOR = Color.BLACK;
    ...
    private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.d("NumberPicker", "readAttrs");
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NumberPicker, defStyleAttr, 0);

        mTextColor = a.getColor(R.styleable.NumberPicker_np_textColor, DEFAULT_TEXT_COLOR);
        mTextSize = a.getDimension(R.styleable.NumberPicker_np_textSize, DEFAULT_TEXT_SIZE * mDensity);
        mStartNumber = a.getInteger(R.styleable.NumberPicker_np_startNumber, 0);
        mEndNumber = a.getInteger(R.styleable.NumberPicker_np_endNumber, 0);
        mCurrentNumber = a.getInteger(R.styleable.NumberPicker_np_currentNumber, 0);
        mVerticalSpacing = (int) a.getDimension(R.styleable.NumberPicker_np_verticalSpacing, DEFAULT_VERTICAL_SPACING * mDensity);

        mFlagText = a.getString(R.styleable.NumberPicker_np_flagText);
        mFlagTextColor = a.getColor(R.styleable.NumberPicker_np_flagTextColor, DEFAULT_FLAG_TEXT_COLOR);
        mFlagTextSize = a.getDimension(R.styleable.NumberPicker_np_flagTextSize, DEFAULT_FLAG_TEXT_SIZE * mDensity);

        mBackgroundColor = a.getColor(R.styleable.NumberPicker_np_background, DEFAULT_BACKGROUND_COLOR);

        mRowNumber = a.getInteger(R.styleable.NumberPicker_np_rowNumber, DEFAULT_LINES);
    ...
    private void initPaint() {
        ...
        if (mShaderPaintTop == null){
            mShaderPaintTop = new Paint();
        }
        if (mShaderPaintBottom == null){
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("NumberPicker", "onMeasure, mTextSize = " + mTextSize);
        measureText();
        ...
        Shader topShader = new LinearGradient(0, 0, 0, mHighLightRect.top, new int[]{
                mBackgroundColor & 0x80FFFFFF,
                mBackgroundColor & 0x40FFFFFF,
    ...
    public NumberPicker setVerticalSpacing(int sapcing) {
        mVerticalSpacing = sapcing;
        requestLayout();
        invalidate();
        return this;
    }
